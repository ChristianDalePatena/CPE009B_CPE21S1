...
class RegistrationForm(QWidget):
    ...
    def initUI(self):
        ...
        self.first_name_input.setStyleSheet("background-color: #ecf0f1; border-radius: 5px; padding: 10px; font-size: 14px;")
        
        self.last_name_label = QLabel("Last Name:")
        self.last_name_label.setStyleSheet("color: #2c3e50; font-size: 14px;")
        self.last_name_input = QLineEdit(self)
        self.last_name_input.setStyleSheet("background-color: #ecf0f1; border-radius: 5px; padding: 10px; font-size: 14px;")
        
        self.username_label = QLabel("Username:")
        self.username_label.setStyleSheet("color: #2c3e50; font-size: 14px;")
        self.username_input = QLineEdit(self)
        self.username_input.setStyleSheet("background-color: #ecf0f1; border-radius: 5px; padding: 10px; font-size: 14px;")
        
        self.password_label = QLabel("Password:")
        self.password_label.setStyleSheet("color: #2c3e50; font-size: 14px;")
        self.password_input = QLineEdit(self)
        self.password_input.setStyleSheet("background-color: #ecf0f1; border-radius: 5px; padding: 10px; font-size: 14px;")
        ...
        self.contact_input.setStyleSheet("background-color: #ecf0f1; border-radius: 5px; padding: 10px; font-size: 14px;")
        
     
        self.submit_button = QPushButton("Submit", self)
        self.submit_button.setStyleSheet("background-color: #1abc9c; color: white; padding: 10px 20px; border-radius: 5px; font-size: 16px;")
        self.submit_button.clicked.connect(self.register_account)
        
        self.clear_button = QPushButton("Clear", self)
        self.clear_button.setStyleSheet("background-color: #e74c3c; color: white; padding: 10px 20px; border-radius: 5px; font-size: 16px;")
