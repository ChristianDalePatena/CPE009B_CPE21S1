...
class Calculator(QMainWindow):
    ...
    def initUI(self):
        ...
        self.textLine.setStyleSheet("background-color: #f0f0f0; padding: 10px;")  
        self.grid.addWidget(self.textLine, 0, 0, 1, 5)
        ...
        for position, name in zip(positions, names):
            ...
            button.setStyleSheet(self.get_button_style(name))  
    ...
    def get_button_style(self, button_text):
        if button_text in ['C', '=', 'sin', 'cos', 'exp']:
            return "background-color: #4CAF50; color: white; border-radius: 10px;"  
        elif button_text in ['/', '*', '-', '+']:
            return "background-color: #ff9800; color: white; border-radius: 10px;" 
        else:
            return "background-color: #2196F3; color: white; border-radius: 10px;"  
